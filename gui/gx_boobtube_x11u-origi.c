...
static LV2UI_Handle instantiate(const struct _LV2UI_Descriptor * descriptor,
	...
	ui->controls[2] = (gx_controller) {{0.5, 0.5, 0.0, 1.0, 0.01}, {180, 30, 61, 61}, false,"TONE", KNOB, TONE};
	ui->controls[3] = (gx_controller) {{0.5, 0.5, 0.0, 1, 0.01}, {250, 30, 61, 61}, false,"VOLUME", KNOB, VOLUME};
...
static void _expose(gx_boobtubeUI *ui) {
	static const char* plug_name = "GxBoobTube" ;
